...
public class MooreNeighborhoodTest {
    ...
    public void getNeighbourhoodPositions() {
        ...
        //when
        LatticePointNeighbourhoodPosition[] neighbourhoodPositions = mooreNeighborhood.getNeighbourhoodPositions();
        ...
        assertSame(neighbourhoodPositions[4],SOUTH_EAST);
        assertSame(neighbourhoodPositions[5],SOUTH);
        assertSame(neighbourhoodPositions[6], SOUTH_WEST);
        assertSame(neighbourhoodPositions[7], WEST);
    }
}
